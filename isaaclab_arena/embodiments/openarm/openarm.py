...
from isaaclab_arena.embodiments.openarm.observations import openarm_left_gripper_pos
from isaaclab_arena.utils.pose import Pose


def _openarm_usd_path() -> str:
    """Resolve the OpenArm USD path inside IsaacLab-Arena."""
