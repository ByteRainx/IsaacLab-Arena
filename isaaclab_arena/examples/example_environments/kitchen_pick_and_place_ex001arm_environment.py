...
class KitchenPickAndPlaceEx001ArmEnvironment(ExampleEnvironmentBase):

    name: str = "kitchen_pick_and_place_ex001arm"
    ...
    def get_env(self, args_cli: argparse.Namespace):  # -> IsaacLabArenaEnvironment:
        ...
        # 默认使用 ex001arm（在 add_cli_args 中设置）
