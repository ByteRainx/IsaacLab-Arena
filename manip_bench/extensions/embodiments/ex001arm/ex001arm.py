...
from manip_bench.extensions.embodiments.ex001arm.actions import ContactLimitedGripperActionCfg
from manip_bench.extensions.embodiments.ex001arm.observations import (
...
def _ex001arm_usd_path() -> str:
    """Resolve the EX001Arm USD path from manip-bench assets."""
    return get_robot_usd_path("ex001arm_bimanual/ex001_arm.usd")
