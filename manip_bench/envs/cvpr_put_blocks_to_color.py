...
"""EX001Arm color-sorting task with CVPR 3DGS background.

Sort colored bricks onto matching paper destinations using bimanual control.
"""
...
class Ex001ArmCvprScenePutBlocksToColorEnvironment(ExampleEnvironmentBase):
    ...
    def get_env(self, args_cli: argparse.Namespace):  # -> IsaacLabArenaEnvironment:
        ...
        from manip_bench.extensions.tasks.put_blocks_to_color import ThreeBlocksToColorTask
