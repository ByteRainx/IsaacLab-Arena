...
def create_teleop_interface(env):
    from manip_bench.extensions.devices.ws_remote import (
        Ex001ArmWsRemoteCfg,
...
def main() -> None:
    ...
    if args_cli.control_mode == "joint":
        from manip_bench.extensions.embodiments.ex001arm.ex001arm import EX001ArmJointActionsCfg
        env_cfg.actions = EX001ArmJointActionsCfg()
        print("[INFO] Using EX001ArmJointActionsCfg (direct joint position, no IK)")
    else:
        from manip_bench.extensions.embodiments.ex001arm.ex001arm import EX001ArmPhysicalTeleopActionsCfg
